            ...
            cancerCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me Největší cancer serveru CraftMania: Warcold, sCuess, MrVakeSK (Upozornuji že je tam napsáno !SK! a !VAKE!), Natt. Navrhnuto uživatelem MARIMR008!")
                    }
                }
            },
            ...
            mckatkaCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me McKatka vám zarapuje! https://www.youtube.com/watch?v=29oA9Ue6mAI #RapGod")
                    }
                }
            },
            ...
            niggaCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me Niggy serveru craftmania: MARIMR008, ShadyCZ")
                    }
                }
            },
            ...
            wakeCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me Pozor! Sežere ti Haribo! :fork_and_knife:")
                    }
                }
            },
